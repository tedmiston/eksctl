...
func makeName(suffix string) gfn.Intrinsic {
...
func makeStringSlice(s ...string) []gfn.Value {
	slice := []gfn.Value{}
	for _, i := range s {
		slice = append(slice, gfn.String(i))
	}
	return slice
}

func (r *resourceSet) newParameter(name, valueType, defaultValue string) gfn.Intrinsic {
...
func (r *resourceSet) newStringParameter(name, defaultValue string) gfn.Intrinsic {
	return r.newParameter(name, "String", defaultValue)
}

func (r *resourceSet) newNumberParameter(name, defaultValue string) gfn.Intrinsic {
...
func (r *resourceSet) newResource(name string, resource interface{}) gfn.Intrinsic {
