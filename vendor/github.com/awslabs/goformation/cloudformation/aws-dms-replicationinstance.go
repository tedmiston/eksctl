...
type AWSDMSReplicationInstance struct {
	...
	ReplicationInstanceClass Value `json:"ReplicationInstanceClass,omitempty"`
	...
	ReplicationInstanceIdentifier Value `json:"ReplicationInstanceIdentifier,omitempty"`
