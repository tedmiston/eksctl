...
type AWSDMSEndpoint_MongoDbSettings struct {
	...
	AuthMechanism Value `json:"AuthMechanism,omitempty"`
	...
	AuthSource Value `json:"AuthSource,omitempty"`
	...
	DocsToInvestigate Value `json:"DocsToInvestigate,omitempty"`
	...
	ExtractDocId Value `json:"ExtractDocId,omitempty"`
	...
	NestingLevel Value `json:"NestingLevel,omitempty"`
